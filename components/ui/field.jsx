...
function FieldLabel({ className, ...props }) {
  return (
    <Label
      ...
      className={cn(
        "group/field-label cursor-pointer peer/field-label flex w-fit gap-2 leading-snug group-data-[disabled=true]/field:opacity-50 has-data-checked:bg-primary/5 has-[>[data-slot=field]]:rounded-md has-[>[data-slot=field]]:border *:data-[slot=field]:p-2 dark:has-data-checked:bg-primary/10",
